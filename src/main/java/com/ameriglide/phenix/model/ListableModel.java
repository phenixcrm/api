...
public class ListableModel<T> extends TypeModel<T> implements Listable<T> {
    ...
    public static class Named<T extends net.inetalliance.types.Named> extends ListableModel<T> {
