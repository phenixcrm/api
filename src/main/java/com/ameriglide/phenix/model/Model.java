...
public class Model<T> extends PhenixServlet {
        ...
        try {
            ...
            if (errors.isEmpty()) {
                try {
                    ...
                    errors.put(name, singleton($M(locale, "validation.uniqueKey", $M(locale, key.info.type), name)));
    ...
    private static Json toJson(final HttpServletResponse response, final Throwable e) throws IOException {
