...
public abstract class Property<O, P>
  ...
  public boolean equals(final Object o) {
    ...
    return field.equals(property.field) && type.equals(property.type);
  }
  ...
  public P apply(final O o) {
    try {
      ...
      if (value == null) {
        ...
        return (P) value;
      } else if (type.isPrimitive() && Classes.wrappers.get(type).isInstance(value)) {
        return (P) value;
      } else {
  ...
  public Property<O, P> rename(final String prefix, final boolean required, final boolean unique,
    ...
    return new Property<>(type, field) {
      ...
      public Iterable<Column> getColumns() {
        ...
        return () -> Iterables.stream(Property.this.getColumns())
            .map(c -> c.rename(prefix, required, unique)).iterator();
      }
  ...
  public P setIf(final O dest, final Map<String, Json> json) {
    if (containsProperty(json)) {
      try {
        final P previousValue = type.cast(field.get(dest));
        final P value = read(previousValue, dest, json);
